...
export interface ApiDogDog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    health: Attribute.Text;
    results: Attribute.Text;
    about: Attribute.Text;
    parents: Attribute.Component<'litter-components.parents', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiLitterLitter extends Schema.CollectionType {
  ...
  attributes: {
    littername: Attribute.String;
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    birth: Attribute.Date;
    bitches: Attribute.Integer;
    males: Attribute.Integer;
    parents: Attribute.Component<'litter-components.parents', true>;
    Puppy: Attribute.Component<'litter-components.puppy', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::litter.litter': ApiLitterLitter;
